...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default='demo', help='Name of the experiment')
    parser.add_argument('--train_batch_size', type=int, default=128, help='Size of the training batch')
    parser.add_argument('--test_batch_size', type=int, default=128, help='Size of the testing batch')
    ...
    parser.add_argument('--lr', type=float, default=3.5e-4, help='Learning rate of AdamW')
    ...
    parser.add_argument('--max_in_degree', type=int, default=4, help='Max in degree of nodes')
    parser.add_argument('--max_out_degree', type=int, default=4, help='max out degree of nodes')
    parser.add_argument('--max_path_distance', type=int, default=3, help='Max pairwise distance between two nodes')
